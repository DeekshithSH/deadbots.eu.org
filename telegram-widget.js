(function(window) {
  ...
  var getWidgetsOrigin = function(default_origin, dev_origin) {
    ...
    if (origin == 'https://telegram.org' || origin == 'https://deekshith.eu.org' || origin == 'https://deekshithsh.github.io') {
  ...
  function initWidget(widgetEl) {
    ...
    if (widgetId = widgetEl.getAttribute('data-telegram-post')) {
      ...
      widgetsOrigin = getWidgetsOrigin('https://telegram.me', 'https://post.tg.dev');
